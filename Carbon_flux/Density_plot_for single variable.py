...
#     # 第一组值:插值与不插值的一起
    ...
    # X_variables = ['Ground_NEE_0_RLM', 'Ground_GPP_0_RLM', 'Ground_RECO_0_RLM', 'Ground_NEE_0', 'Ground_GPP_0', 'Ground_RECO_0']
...
#
    ...
    plt.savefig(resluts_path + 'NEE comparison of all models' + '_scenario 14' + '.png', dpi=300)
    # Display the plot
    plt.show()