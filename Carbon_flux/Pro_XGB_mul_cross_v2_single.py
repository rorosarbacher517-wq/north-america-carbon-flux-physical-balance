...
if __name__ == "__main__":
    ...
    x_image_array, y_image_array, x_inter_mask_array0, y_qa_array = Data_filter_match.mul_match_x_y_modis_quality(
        ...
        NEE_GPP_RECO_filledvalue=0, is_inter=1)
    ...
    np.save(results_variation_path + 'XGB_RLM_NEE_predict_good_modis.npy', x_inter_mask_array)
    np.save(results_variation_path + 'XGB_RLM_NEE_y_qa_good_modis.npy', y_flux_qa_array)
    # 将质量标识的波段去除
    ...
    np.save(results_variation_path + 'XGB_RLM_NEE_predict_good_modis.npy', Y_pred_filtered_array)
    np.save(results_variation_path + 'XGB_RLM_NEE_true_good_modis.npy', Y_test_filtered_array)
    np.save(results_variation_path + 'XGB_RLM_NEE_site_good_modis.npy', XGB_test_sites_array)
