...
if __name__ == "__main__":
    ...
    DL_NEE_0_no_physical, DL_GPP_0_no_physical, DL_RECO_0_no_physical, Ground_NEE_0, Ground_GPP_0, Ground_RECO_0, XGB_NEE_0, XGB_GPP_0, XGB_RECO_0 = interpolation_quality(
        DL_Y_predict_no_physical, DL_Y_true_no_physical, inter_mask_no_physical, DL_y_qa_no_physical, XGB_NEE_predict, XGB_GPP_predict, XGB_RECO_predict, is_inter=0)
    DL_NEE_1_no_physical, DL_GPP_1_no_physical, DL_RECO_1_no_physical, Ground_NEE_1, Ground_GPP_1, Ground_RECO_1, XGB_NEE_1, XGB_GPP_1, XGB_RECO_1 = interpolation_quality(
        DL_Y_predict_no_physical, DL_Y_true_no_physical, inter_mask_no_physical, DL_y_qa_no_physical, XGB_NEE_predict, XGB_GPP_predict, XGB_RECO_predict, is_inter=1)
    DL_NEE_2_no_physical, DL_GPP_2_no_physical, DL_RECO_2_no_physical, Ground_NEE_2, Ground_GPP_2, Ground_RECO_2, XGB_NEE_2, XGB_GPP_2, XGB_RECO_2 = interpolation_quality(
        DL_Y_predict_no_physical, DL_Y_true_no_physical, inter_mask_no_physical, DL_y_qa_no_physical, XGB_NEE_predict, XGB_GPP_predict, XGB_RECO_predict, is_inter=2)
    ...
    DL_NEE_0_RLM, DL_GPP_0_RLM, DL_RECO_0_RLM, Ground_NEE_0_RLM, Ground_GPP_0_RLM, Ground_RECO_0_RLM, RF_NEE_0_RLM, RF_GPP_0_RLM, RF_RECO_0_RLM = interpolation_quality(
        DL_Y_predict_RLM, DL_Y_true_RLM, inter_mask_RLM, DL_y_qa_RLM, RF_NEE_predict_RLM, RF_GPP_predict_RLM, RF_RECO_predict_RLM, is_inter=0)
    DL_NEE_1_RLM, DL_GPP_1_RLM, DL_RECO_1_RLM, Ground_NEE_1_RLM, Ground_GPP_1_RLM, Ground_RECO_1_RLM, RF_NEE_1_RLM, RF_GPP_1_RLM, RF_RECO_1_RLM = interpolation_quality(
        DL_Y_predict_RLM, DL_Y_true_RLM, inter_mask_RLM, DL_y_qa_RLM, RF_NEE_predict_RLM, RF_GPP_predict_RLM, RF_RECO_predict_RLM, is_inter=1)
    DL_NEE_2_RLM, DL_GPP_2_RLM, DL_RECO_2_RLM, Ground_NEE_2_RLM, Ground_GPP_2_RLM, Ground_RECO_2_RLM, RF_NEE_2_RLM, RF_GPP_2_RLM, RF_RECO_2_RLM = interpolation_quality(
        DL_Y_predict_RLM, DL_Y_true_RLM, inter_mask_RLM, DL_y_qa_RLM, RF_NEE_predict_RLM, RF_GPP_predict_RLM, RF_RECO_predict_RLM, is_inter=2)
    ...
    DL_NEE_0_no_physical_RLM, DL_GPP_0_no_physical_RLM, DL_RECO_0_no_physical_RLM, Ground_NEE_0_RLM, Ground_GPP_0_RLM, Ground_RECO_0_RLM, XGB_NEE_0_RLM, XGB_GPP_0_RLM, XGB_RECO_0_RLM = interpolation_quality(
        DL_Y_predict_no_physical_RLM, DL_Y_true_no_physical_RLM, inter_mask_no_physical_RLM, DL_y_qa_no_physical_RLM, XGB_NEE_predict_RLM,XGB_GPP_predict_RLM, XGB_RECO_predict_RLM, is_inter=0)
    DL_NEE_1_no_physical_RLM, DL_GPP_1_no_physical_RLM, DL_RECO_1_no_physical_RLM, Ground_NEE_1_RLM, Ground_GPP_1_RLM, Ground_RECO_1_RLM, XGB_NEE_1_RLM, XGB_GPP_1_RLM, XGB_RECO_1_RLM = interpolation_quality(
        DL_Y_predict_no_physical_RLM, DL_Y_true_no_physical_RLM, inter_mask_no_physical_RLM, DL_y_qa_no_physical_RLM,XGB_NEE_predict_RLM,XGB_GPP_predict_RLM, XGB_RECO_predict_RLM, is_inter=1)
    DL_NEE_2_no_physical_RLM, DL_GPP_2_no_physical_RLM, DL_RECO_2_no_physical_RLM, Ground_NEE_2_RLM, Ground_GPP_2_RLM, Ground_RECO_2_RLM, XGB_NEE_2_RLM, XGB_GPP_2_RLM, XGB_RECO_2_RLM = interpolation_quality(
        DL_Y_predict_no_physical_RLM, DL_Y_true_no_physical_RLM, inter_mask_no_physical_RLM, DL_y_qa_no_physical_RLM,XGB_NEE_predict_RLM,XGB_GPP_predict_RLM, XGB_RECO_predict_RLM, is_inter=2)

    print('hhh')
    # X_variables = ['Ground_NEE_2_RLM','Ground_NEE_2_RLM','Ground_NEE_2_RLM','Ground_NEE_2_RLM','Ground_NEE_2', 'Ground_NEE_2', 'Ground_NEE_2', 'Ground_NEE_2']
    # Y_variables = ['DL_NEE_2_RLM', 'DL_NEE_2_no_physical_RLM', 'XGB_NEE_2_RLM', 'RF_NEE_2_RLM','DL_NEE_2', 'DL_NEE_2_no_physical', 'XGB_NEE_2', 'RF_NEE_2']
    X_variables = ['Ground_RECO_0_RLM', 'Ground_RECO_1_RLM', 'Ground_RECO_2_RLM', 'Ground_RECO_0_RLM', 'Ground_RECO_1_RLM', 'Ground_RECO_2_RLM',
                   'Ground_RECO_0_RLM', 'Ground_RECO_1_RLM', 'Ground_RECO_2_RLM', 'Ground_RECO_0_RLM', 'Ground_RECO_1_RLM', 'Ground_RECO_2_RLM',
                   'Ground_RECO_0', 'Ground_RECO_1', 'Ground_RECO_2', 'Ground_RECO_0', 'Ground_RECO_1', 'Ground_RECO_2',
                   'Ground_RECO_0', 'Ground_RECO_1', 'Ground_RECO_2', 'Ground_RECO_0', 'Ground_RECO_1', 'Ground_RECO_2',]
    Y_variables = ['DL_RECO_0_RLM','DL_RECO_1_RLM','DL_RECO_2_RLM','DL_RECO_0_no_physical_RLM','DL_RECO_1_no_physical_RLM', 'DL_RECO_2_no_physical_RLM',
                   'XGB_RECO_0_RLM', 'XGB_RECO_1_RLM', 'XGB_RECO_2_RLM','RF_RECO_0_RLM','RF_RECO_1_RLM','RF_RECO_2_RLM',
                   'DL_RECO_0','DL_RECO_1','DL_RECO_2','DL_RECO_0_no_physical','DL_RECO_1_no_physical','DL_RECO_2_no_physical',
                   'XGB_RECO_0', 'XGB_RECO_1', 'XGB_RECO_2','RF_RECO_0','RF_RECO_1','RF_RECO_2']
    ...
    model_subtitle = ['CFR with physical-constraints', 'CFR without physical-constraints', 'XGBoost', 'RF']
    ...
    for i in range(24):  # Modify the range to match the 2x4 grid
        row = i // 4
        col = i % 4
