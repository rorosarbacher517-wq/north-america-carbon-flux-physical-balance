...
if __name__ == "__main__":
    ...
    np.save(results_variation_path + 'XGB_RL_NEE_x_mask_soil.npy', x_inter_mask_array)
    np.save(results_variation_path + 'XGB_RL_NEE_y_qa_soil.npy', y_flux_qa_array)
    # 将质量标识的波段去除
    ...
    for kth_data in cross_validation_data:
        ...
        XGBmodel.fit(XGB_input_images_train_norm4_clean[:,:11], XGB_trainy_input)
        # r_score = XGBmodel.score(XGB_input_images_test_norm4_clean[:, :], XGB_testy_input)
        # print(r_score)
        y_pred = XGBmodel.predict(XGB_input_images_test_norm4_clean[:, :11])
    ...
    np.save(results_variation_path + 'XGB_RL_NEE_predict_soil.npy', Y_pred_filtered_array)
    np.save(results_variation_path + 'XGB_RL_NEE_true_soil.npy', Y_test_filtered_array)
    np.save(results_variation_path + 'XGB_RL_NEE_site_soil.npy', XGB_test_sites_array)
