...
if __name__ == "__main__":
    ...
    DL_Y_predict = np.load("D:\Carbon_flux\data\sites_estimate_result\DL_RLM_predict5.npy", allow_pickle=True)
    DL_Y_true = np.load("D:\Carbon_flux\data\sites_estimate_result\DL_RLM_true5.npy", allow_pickle=True)
    DL_All_true = np.load("D:\Carbon_flux\data\sites_estimate_result\DL_RLM_sites5.npy", allow_pickle=True)
    inter_mask = np.load("D:\Carbon_flux\data\sites_estimate_result\DL_RLM_x_mask5.npy", allow_pickle=True)
    DL_y_qa = np.load("D:\Carbon_flux\data\sites_estimate_result\DL_RLM_y_qa5.npy", allow_pickle=True)
    ...
    # DL_Y_true[:,:,1]
    DL_Y_predict_no_physical = np.load(inputdata_path + 'DL_RL_predict_indicators_1.npy', allow_pickle=True)
    DL_Y_true_no_physical = np.load(inputdata_path + 'DL_RL_true_indicators_1.npy', allow_pickle=True)
    DL_All_true_no_physical = np.load(inputdata_path + 'DL_RL_sites_indicators_1.npy', allow_pickle=True)
    inter_mask_no_physical = np.load(inputdata_path + 'DL_RL_x_mask_indicators_1.npy', allow_pickle=True)
    DL_y_qa_no_physical = np.load(inputdata_path + 'DL_RL_y_qa_indicators_1.npy', allow_pickle=True)
    ...
    DL_Y_predict_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_predict_indicators_1.npy', allow_pickle=True)
    DL_Y_true_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_true_indicators_1.npy', allow_pickle=True)
    DL_All_true_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_sites_indicators_1.npy', allow_pickle=True)
    inter_mask_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_x_mask_indicators_1.npy', allow_pickle=True)
    DL_y_qa_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_y_qa_indicators_1.npy', allow_pickle=True)
...
#     # 第一组值:插值与不插值的一起
    ...
    # Define the variables used for plotting
    X_variables = ['Ground_NEE_0_RLM', 'Ground_GPP_0_RLM', 'Ground_RECO_0_RLM', 'Ground_NEE_0_RLM', 'Ground_GPP_0_RLM',
                   'Ground_RECO_0_RLM']

    Y_variables = ['DL_NEE_0_RLM', 'DL_GPP_0_RLM', 'DL_RECO_0_RLM', 'DL_NEE_0_no_physical_RLM',
                   'DL_GPP_0_no_physical_RLM', 'DL_RECO_0_no_physical_RLM', ] # Example variables
    model_subtitle = ['NEE', 'GPP', 'RECO']
    ...
    fig.text(0.5, 0.05, 'Input with meteorological variables (g C m$^{-2}$ d$^{-1}$)', ha='center', va='center', fontsize=18,

             fontname='Arial')



    fig.text(0.03, 0.7, 'Input without\nvegetation indices', ha='center', va='center', rotation='vertical',

             fontsize=18, fontname='Arial')

    fig.text(0.03, 0.3, 'Input with\nvegetation indices', ha='center', va='center', rotation='vertical',
    ...
    plt.savefig(resluts_path + 'vegetation indices_RLM_0702' + '.png', dpi=300)
