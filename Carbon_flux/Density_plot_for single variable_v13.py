...
if __name__ == "__main__":
    # download the data
    inputdata_path = './data/sites_modis_noise_copy/'
    # inputdata_path = './data/Sites_results_copy/'
    # linear dl
    DL_Y_predict = np.load(inputdata_path + 'DL_RL_predict_0.01.npy', allow_pickle=True)
    DL_Y_true = np.load(inputdata_path + 'DL_RL_true_0.01.npy', allow_pickle=True)
    DL_All_true = np.load(inputdata_path + 'DL_RL_sites_0.01.npy', allow_pickle=True)
    inter_mask = np.load(inputdata_path + 'DL_RL_x_mask_0.01.npy', allow_pickle=True)
    DL_y_qa = np.load(inputdata_path + 'DL_RL_y_qa_0.01.npy', allow_pickle=True)
    # DL_Y_true[:,:,1]
    DL_Y_predict_no_physical = np.load(inputdata_path + 'DL_RL_predict_three_0.01.npy', allow_pickle=True)
    DL_Y_true_no_physical = np.load(inputdata_path + 'DL_RL_true_three_0.01.npy', allow_pickle=True)
    DL_All_true_no_physical = np.load(inputdata_path + 'DL_RL_sites_three_0.01.npy', allow_pickle=True)
    inter_mask_no_physical = np.load(inputdata_path + 'DL_RL_x_mask_three_0.01.npy', allow_pickle=True)
    DL_y_qa_no_physical = np.load(inputdata_path + 'DL_RL_y_qa_three_0.01.npy', allow_pickle=True)

    # RF three
    RF_NEE_predict = np.load(inputdata_path + 'RF_RL_NEE_predict_noise_0.01.npy', allow_pickle=True)
    RF_NEE_true = np.load(inputdata_path + 'RF_RL_NEE_true_noise_0.01.npy', allow_pickle=True)

    RF_GPP_predict = np.load(inputdata_path + 'RF_RL_GPP_predict_noise_0.01.npy', allow_pickle=True)
    RF_GPP_true = np.load(inputdata_path + 'RF_RL_GPP_true_noise_0.01.npy', allow_pickle=True)

    RF_RECO_predict = np.load(inputdata_path + 'RF_RL_RECO_predict_noise_0.01.npy', allow_pickle=True)
    RF_RECO_true = np.load(inputdata_path + 'RF_RL_RECO_true_noise_0.01.npy', allow_pickle=True)

    # XGB three
    XGB_NEE_predict = np.load(inputdata_path + 'XGB_RL_NEE_predict_noise_0.01.npy', allow_pickle=True)
    XGB_NEE_true = np.load(inputdata_path + 'XGB_RL_NEE_true_noise_0.01.npy', allow_pickle=True)

    XGB_GPP_predict = np.load(inputdata_path + 'XGB_RL_GPP_predict_noise_0.01.npy', allow_pickle=True)
    XGB_GPP_true = np.load(inputdata_path + 'XGB_RL_GPP_true_noise_0.01.npy', allow_pickle=True)

    XGB_RECO_predict = np.load(inputdata_path + 'XGB_RL_RECO_predict_noise_0.01.npy', allow_pickle=True)
    XGB_RECO_true = np.load(inputdata_path + 'XGB_RL_RECO_true_noise_0.01.npy', allow_pickle=True)
    ...
    # linear dl
    DL_Y_predict_RLM = np.load(inputdata_path + 'DL_RLM_predict_0.01.npy', allow_pickle=True)
    DL_Y_true_RLM = np.load(inputdata_path + 'DL_RLM_true_0.01.npy', allow_pickle=True)
    DL_All_true_RLM = np.load(inputdata_path + 'DL_RLM_sites_0.01.npy', allow_pickle=True)
    inter_mask_RLM = np.load(inputdata_path + 'DL_RLM_x_mask_0.01.npy', allow_pickle=True)
    DL_y_qa_RLM = np.load(inputdata_path + 'DL_RLM_y_qa_0.01.npy', allow_pickle=True)
    ...
    DL_Y_predict_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_predict_three_0.01.npy', allow_pickle=True)
    DL_Y_true_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_true_three_0.01.npy', allow_pickle=True)
    DL_All_true_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_sites_three_0.01.npy', allow_pickle=True)
    inter_mask_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_x_mask_three_0.01.npy', allow_pickle=True)
    DL_y_qa_no_physical_RLM = np.load(inputdata_path + 'DL_RLM_y_qa_three_0.01.npy', allow_pickle=True)

    # RF three
    RF_NEE_predict_RLM = np.load(inputdata_path + 'RF_RLM_NEE_predict_noise_0.01.npy', allow_pickle=True)
    RF_NEE_true_RLM = np.load(inputdata_path + 'RF_RLM_NEE_true_noise_0.01.npy', allow_pickle=True)

    RF_GPP_predict_RLM = np.load(inputdata_path + 'RF_RLM_GPP_predict_noise_0.01.npy', allow_pickle=True)
    RF_GPP_true_RLM = np.load(inputdata_path + 'RF_RLM_GPP_true_noise_0.01.npy', allow_pickle=True)

    RF_RECO_predict_RLM = np.load(inputdata_path + 'RF_RLM_RECO_predict_noise_0.01.npy', allow_pickle=True)
    RF_RECO_true_RLM = np.load(inputdata_path + 'RF_RLM_RECO_true_noise_0.01.npy', allow_pickle=True)

    # XGB three
    XGB_NEE_predict_RLM = np.load(inputdata_path + 'XGB_RLM_NEE_predict_noise_0.01.npy', allow_pickle=True)
    XGB_NEE_true_RLM = np.load(inputdata_path + 'XGB_RLM_NEE_true_noise_0.01.npy', allow_pickle=True)
    #
    XGB_GPP_predict_RLM = np.load(inputdata_path + 'XGB_RLM_GPP_predict_noise_0.01.npy', allow_pickle=True)
    XGB_GPP_true_RLM = np.load(inputdata_path + 'XGB_RLM_GPP_true_noise_0.01.npy', allow_pickle=True)

    XGB_RECO_predict_RLM = np.load(inputdata_path + 'XGB_RLM_RECO_predict_noise_0.01.npy', allow_pickle=True)
    XGB_RECO_true_RLM = np.load(inputdata_path + 'XGB_RLM_RECO_true_noise_0.01.npy', allow_pickle=True)

   #*******************************
    # DL 单独预测的 有气象数据
    DL_NEE_predict_RLM_Single = np.load(inputdata_path + 'DL_RLM_NEE_predict_single_0.01.npy', allow_pickle=True)
    DL_NEE_true_RLM_Single = np.load(inputdata_path + 'DL_RLM_NEE_true_single_0.01.npy', allow_pickle=True)
    #
    DL_GPP_predict_RLM_Single = np.load(inputdata_path + 'DL_RLM_GPP_predict_single_0.01.npy', allow_pickle=True)
    DL_GPP_true_RLM_Single = np.load(inputdata_path + 'DL_RLM_GPP_true_single_0.01.npy', allow_pickle=True)

    DL_RECO_predict_RLM_Single = np.load(inputdata_path + 'DL_RLM_RECO_predict_single_0.01.npy', allow_pickle=True)
    DL_RECO_true_RLM_Single = np.load(inputdata_path + 'DL_RLM_RECO_true_single_0.01.npy', allow_pickle=True)
    ...
    #*******************
    # DL 单独预测的 没有气象变量数据
    DL_NEE_predict_RL_Single = np.load(inputdata_path + 'DL_RL_NEE_predict_single_0.01.npy', allow_pickle=True)
    DL_NEE_true_RL_Single = np.load(inputdata_path + 'DL_RL_NEE_true_single_0.01.npy', allow_pickle=True)
    #
    DL_GPP_predict_RL_Single = np.load(inputdata_path + 'DL_RL_GPP_predict_single_0.01.npy', allow_pickle=True)
    DL_GPP_true_RL_Single = np.load(inputdata_path + 'DL_RL_GPP_true_single_0.01.npy', allow_pickle=True)

    DL_RECO_predict_RL_Single = np.load(inputdata_path + 'DL_RL_RECO_predict_single_0.01.npy', allow_pickle=True)
    DL_RECO_true_RL_Single = np.load(inputdata_path + 'DL_RL_RECO_true_single_0.01.npy', allow_pickle=True)
...
#     # RF 有气象变量
    ...
    X_variables = ['Ground_GPP_0_RLM','Ground_GPP_0_RLM','Ground_GPP_0_RLM','Ground_GPP_0_RLM','Ground_GPP_0_RLM','Ground_GPP_0_RLM','Ground_GPP_0','Ground_GPP_0','Ground_GPP_0', 'Ground_GPP_0']
    Y_variables = ['DL_GPP_0_RLM','DL_GPP_0_no_physical_RLM', 'DL_GPP_0_RLM_Single','XGB_GPP_0_RLM', 'RF_GPP_0_RLM','DL_GPP_0','DL_GPP_0_no_physical','DL_GPP_0_RL_Single','XGB_GPP_0', 'RF_GPP_0']
    #*************************************************
    # # GPP 与 GPP-GPP的最大最小中位数等
    # bias_transformer_single_variable_RLM = np.abs(RF_NEE_0_RLM-(RF_RECO_0_RLM-RF_GPP_0_RLM))
    # #
    # # # 计算统计量
    # minimum = np.min(bias_transformer_single_variable_RLM)
    # maximum = np.max(bias_transformer_single_variable_RLM)
    # median = np.median(bias_transformer_single_variable_RLM)
    # mean = np.mean(bias_transformer_single_variable_RLM)
    # std_dev = np.std(bias_transformer_single_variable_RLM)
    # # 打印结果，保留两位小数
    ...
    model_subtitle = ['Physics-aware\ntransformer','Transformer\nthree-variables','Transformer\nsingle-variable', 'XGBoost', 'RF']# 'CFR without physical constraints',
    # model_subtitle = ['NEE', 'GPP', 'RECO']  # 'CFR without physical constraints',
    ax_subtitle = ['(a)', '(b)', '(c)', '(d)','(e)','(f)','(g)','(h)','(i)','(j)'] # ,'(g)','(h)'
    import matplotlib.pyplot as plt
    # 设置共享colorbar位置
    ...
    for i in range(10):
        ...
        # 添加 ax_subtitle 到右下方
        axs[row, col].text(0.95, 0.01, ax_subtitle[i], ha='right', va='bottom', transform=axs[row, col].transAxes,
                           fontsize=18)
    ...
    resluts_path = 'E:/The North America ecosystem carbon flux/PPT_GRAPHS/Graphs/noise_injection_result/'
    plt.savefig(resluts_path + 'GPP_0.01_0403' + '.png', dpi=300)
    # Display the plot
    plt.show()
