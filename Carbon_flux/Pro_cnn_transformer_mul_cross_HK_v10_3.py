...
if __name__ == "__main__":
    ...
    np.save(results_variation_path + 'DL_RLM_x_mask_0.01_1.npy', x_inter_mask_array)
    np.save(results_variation_path + 'DL_RLM_y_qa_0.01_1.npy',y_flux_qa_array)  # y_flux_qa_array.shape (1688, 365, 5), the fouth dimension is QA
    # 将质量标识的波段去除
    ...
    for ik, kth_data in enumerate(cross_validation_data):
        ...
        # model_pre_name = f'./region model/get_cnn_transformer_RL_epoch_{ik + 1}.h5'
    ...
    np.save(results_variation_path + 'DL_RLM_predict_0.01_1.npy', Y_pred_filtered_array)
    np.save(results_variation_path + 'DL_RLM_true_0.01_1.npy', Y_test_filtered_array)
    np.save(results_variation_path + 'DL_RLM_sites_0.01_1.npy', Y_test_sites_array)
