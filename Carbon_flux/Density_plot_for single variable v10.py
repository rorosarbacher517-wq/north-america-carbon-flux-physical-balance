...
if __name__ == "__main__":
    ...
    mask_1 = Ground_NEE_1_RLM != -9999
    mask_2 = Ground_NEE_2_RLM != -9999

    DL_NEE_0_RLM_filtered = DL_NEE_0_RLM[mask_0]
    DL_NEE_1_RLM_filtered = DL_NEE_1_RLM[mask_1]
    DL_NEE_2_RLM_filtered = DL_NEE_2_RLM[mask_2]

    Ground_NEE_0_RLM_filtered = Ground_NEE_0_RLM[mask_0]
    Ground_NEE_1_RLM_filtered = Ground_NEE_1_RLM[mask_1]
    Ground_NEE_2_RLM_filtered = Ground_NEE_2_RLM[mask_2]
    ...
    mask_RL_1 = Ground_NEE_1_RL != -9999
    mask_RL_2 = Ground_NEE_2_RL != -9999

    DL_NEE_0_RL_filtered = DL_NEE_0_RL[mask_RL_0]
    DL_NEE_1_RL_filtered = DL_NEE_1_RL[mask_RL_1]
    DL_NEE_2_RL_filtered = DL_NEE_2_RL[mask_RL_2]

    Ground_NEE_0_RL_filtered = Ground_NEE_0_RL[mask_RL_0]
    Ground_NEE_1_RL_filtered = Ground_NEE_1_RL[mask_RL_1]
    Ground_NEE_2_RL_filtered = Ground_NEE_2_RL[mask_RL_2]
    # print(min(Ground_GPP_0_RLM),min(DL_GPP_0_RLM),min(DL_GPP_0_no_physical_RLM),min(XGB_GPP_0),min(RF_GPP_0_RLM))
    X_variables = ['Ground_NEE_0_RLM_filtered','Ground_NEE_1_RLM_filtered','Ground_NEE_2_RLM_filtered','Ground_NEE_0_RL_filtered',
                   'Ground_NEE_1_RL_filtered','Ground_NEE_2_RL_filtered']
    Y_variables = ['DL_NEE_0_RLM_filtered','DL_NEE_1_RLM_filtered', 'DL_NEE_2_RLM_filtered',
                   'DL_NEE_0_RL_filtered','DL_NEE_1_RL_filtered', 'DL_NEE_2_RL_filtered']
    ...
    plt.savefig(resluts_path + 'NEE three input' + '.png', dpi=300)
    # Display the plot
    plt.show()
