...
if __name__ == "__main__":
    ...
    x_image_array[203,:,:,0,1]
    y_image_array[203:207,0,:]
    ...
    np.save(results_variation_path + 'DL_RL_x_mask_no_physical_0705.npy', x_inter_mask_array)
    np.save(results_variation_path + 'DL_RL_y_qa_no_physical_0705.npy', y_flux_qa_array) # y_flux_qa_array.shape (1688, 365, 5), the fouth dimension is QA
    # 将质量标识的波段去除
    ...
    importlib.reload(myloss)
    loss = myloss.mask_loss(maskValue=-9999)
    ...
    sites_training_test_path = './data/sites_input/'
    np.save(sites_training_test_path + f'x_image_array.npy',x_image_array)
    np.save(sites_training_test_path + f'y_image_array.npy', y_image_array)
    ...
    for ik, kth_data in enumerate(cross_validation_data):
        ...
        sites_training_test_path = './data/sites_training_test/'
        np.save(sites_training_test_path + f'input_images_train_norm3_{ik}.npy', input_images_train_norm3)
        np.save(sites_training_test_path + f'input_covariate_train_norm3_{ik}.npy', input_covariate_train_norm3)
        np.save(sites_training_test_path + f'trainy_{ik}.npy', trainy)
        print(input_images_train_norm3.shape)
        ...
        np.save(sites_training_test_path + f'input_images_test_norm3_{ik}.npy', input_images_test_norm3)
        np.save(sites_training_test_path + f'input_covariate_test_norm3_{ik}.npy', input_covariate_test_norm3)
        np.save(sites_training_test_path + f'testy_{ik}.npy', testy)
        print(input_images_test_norm3.shape)
    ...
    np.save(results_variation_path + 'DL_RLM_predict_no_physical_0705.npy', Y_pred_filtered_array)
    np.save(results_variation_path + 'DL_RLM_true_no_physical_0705.npy', Y_test_filtered_array)
    np.save(results_variation_path + 'DL_RLM_sites_no_physical_0705.npy', Y_test_sites_array)
    ...
    #
    # # base_name = 'Results of Deep learning using reflectances, LAI, FPAR, and meteorological variables'
    ...
    # plt.savefig(resluts_path + base_name + '.png', dpi=300)
    # plt.show()
