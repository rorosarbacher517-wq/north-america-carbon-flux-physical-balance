...
#     # 第一组值:插值与不插值的一起
    ...
    for i in range(8):
        ...
        # 创建2D直方图
        h = axs[row, col].hist2d(x, y, bins=200, cmap=cmap, norm=Normalize(vmin=density_threshold))
    ...
    cb.ax.set_title('Number', fontdict={"size": 18, "color": "k", 'family': 'Times New Roman'}, pad=10)
    ...
    plt.savefig(resluts_path + 'RECO comparison of all models' + '_scenario 30_v3' + '.png', dpi=300)
    # Display the plot
    plt.show()
