...
shp_path = "E:/HLS carbon flux/data/Sites data/Ameriflux_site_csv_shp/Ameriflux_site_3km.geojson"   ##'E:/HLS carbon flux/data/sites_263_shp/Sites_263_3km_buffer.geojson'
...
for i in range(153, 156):
    ...
    for year in years:
        ...
        task2 = appears.get_request_polygon_shape_task2(nps_gc, task, token, fail_sams, name_prefix="", polygon_index=0)
        appears.download_task_polygon_shape_task2(token, station_destDir, check_frequency=3600, is_download=False,
                                                  task_str="ARD_C2_n")
