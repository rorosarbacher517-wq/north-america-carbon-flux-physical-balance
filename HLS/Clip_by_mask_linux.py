...
# ================ 配置参数 ================
geojson_path = r"/dat1/Fanbin_data/HLS/Ameriflux_boundary/Ameriflux_site_3.5km.geojson"
base_dir = r"/dat1/Fanbin_data/HLS/HLS_Sites_3km_images/0_80"
# ========================================
...
for site_name in site_list[2:3]:  # 处理第4个站点
