...
# # 调用函数
# read_and_process_tiff_blocks('state/222.tif', block_size=32)
...
#                 # geotransformation_dir = os.path.join(geotransformation_block_dir, "geotransformation")
#                 # if not os.path.isdir(geotransformation_dir):
#                 #     os.makedirs(geotransformation_dir)
...
if __name__ == '__main__':
    ...
    for s in range(20,31): # len(state_list)
