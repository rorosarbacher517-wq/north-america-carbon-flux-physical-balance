...
if __name__ == "__main__":
    ...
    ref_array = np.load(inputdata_path + 'x_ref_modis_new_mark.npy', allow_pickle=True)
    ...
    # 保存插值后的数据
    np.save(output_path + 'x_ref_modis_new_mark_interpolation.npy', interpolated_array3)