...
if __name__ == "__main__":
    ...
    fpar_lai_array = np.load(inputdata_path + 'x_lai_array_modis_0_271_mark.npy', allow_pickle=True)
    ...
    # 保存插值后的数据
    np.save(output_path + 'x_lai_array_modis_0_271_interpolation.npy', interpolated_array2)
