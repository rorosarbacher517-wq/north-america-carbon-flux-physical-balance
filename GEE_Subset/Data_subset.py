...
if __name__ == '__main__':
    sites_df = pd.read_csv("E:/China forest/data/Image/Natural Data_Productivity as related to diversity and age in planted versus natural forests_drop_duplicate.csv")
    # df = pd.read_csv('C:/Users/wuth/Desktop/image_df.csv')
    # print(df.head(5))
    ## 创建影像存储的根目录
    sites_image_root_path = 'E:/China forest/data/Image'
    nodata_list = []
    ...
    nodata_df.to_csv('E:/Carbon_flux/data/nodata/nodata_df_0_50_10.csv')
