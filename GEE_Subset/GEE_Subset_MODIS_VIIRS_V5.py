...
service_account = 'sentinel-data-download-2@sentinel-data-download-2.iam.gserviceaccount.com'
credentials = ee.ServiceAccountCredentials(service_account, "E:/Personal infomation/GEE_json/che/che/sentinel-data-download-2-7b6e20a27f0d.json")
...
if __name__ == '__main__':
    ...
    # print(df.head(5))
    ## 创建影像存储的根目录
    sites_image_root_path = 'E:/HLS carbon flux/data/Sites data/MODIS time series/MCD15A3H'
    ...
    nodata_df_out.to_csv('E:/Carbon_flux/data/nodata/nodata_df_300_345.csv', index=False)
# if __name__ == '__main__':
#     sites_df = pd.read_csv("E:/HLS carbon flux/data/Sites data/MODIS time series/sites_list_csv/AFO_total.csv")
#     sites_image_root_path = 'E:/HLS carbon flux/data/Sites data/MODIS time series/MCD43A4'
#     nodata_list = []
#     nodata_df = pd.DataFrame()
#
#     for m in range(300, len(sites_df)):
#         site_id = sites_df['Site_Id'][m]
#         site_lat = sites_df['Latitude'][m]
#         site_lon = sites_df['Longitude'][m]
#         site_path = os.path.join(sites_image_root_path, site_id)
