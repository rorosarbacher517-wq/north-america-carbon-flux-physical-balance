...
service_account = 'sentinel-data-download-1@sentinel-data-download-1.iam.gserviceaccount.com'
credentials = ee.ServiceAccountCredentials(service_account, "E:/Personal infomation/GEE_json/che/che/sentinel-data-download-1-ca8d7b7455e9.json")
...
def get_product_band(year):
    ...
    if year > 1999 and year < 2025:
        ...
        band_list = ['Nadir_Reflectance_I1', 'Nadir_Reflectance_I2', 'Nadir_Reflectance_I3',
                     'BRDF_Albedo_Band_Mandatory_Quality_I1', 'BRDF_Albedo_Band_Mandatory_Quality_I2',
...
if __name__ == '__main__':
    ...
    for m in range(315,len(sites_df)):
    ...
    nodata_df_out.to_csv('E:/Carbon_flux/data/nodata/nodata_df_240_300.csv', index=False)
