...
if __name__ == '__main__':
    ...
    for state in states_list[3:]:  # Limiting to the first 2 states for demonstration purposes
        ...
        while current_date <= end_date:
            ...
            for i, product in enumerate(product_list):
                ...
                if image is not None:
                    ...
                    geemap.ee_export_image(composite, filename=out_tif, region=roi, crs='EPSG:4326', scale=500, file_per_band=False)
